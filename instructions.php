...
<div id="tab-enrolled" class="tab-content">
  ...
  <div class="section" style="margin-top:0">
    ...
    <a href="<?= $payments_base ?>guestold_student" class="btn btn-primary no-print" style="margin-top:14px; background:linear-gradient(135deg,#0e8a6b,#15b88f); color:#fff; width:100%; justify-content:center; border:none">Pay as Enrolled</a>
  </div>
</div>
...
<div id="tab-other" class="tab-content">
  ...
  <div class="section" style="margin-top:0">
    ...
    <a href="<?= $payments_base ?>guestold" class="btn btn-primary no-print" style="margin-top:14px; background:linear-gradient(135deg,#b45309,#f59e0b); color:#fff; width:100%; justify-content:center; border:none">Pay Other Fees</a>
  </div>
</div>
