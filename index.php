...
<section id="pay-options" class="cards">
  ...
  <article class="pay-card featured">
    ...
    <a href="<?= $payments_base ?>guest" class="btn btn-primary"><i class="fa-solid fa-arrow-right"></i> Pay as New Enrollee</a>
  </article>
  ...
  <article class="pay-card">
    ...
    <a href="<?= $payments_base ?>guestold_student" class="btn btn-primary" style="background:linear-gradient(135deg,#0e8a6b,#15b88f)"><i class="fa-solid fa-arrow-right"></i> Pay as Enrolled</a>
  </article>
  ...
  <article class="pay-card">
    ...
    <a href="<?= $payments_base ?>guestold" class="btn btn-primary" style="background:linear-gradient(135deg,#d97706,#ffb84d)"><i class="fa-solid fa-arrow-right"></i> Pay Other Fees</a>
  </article>
</section>
